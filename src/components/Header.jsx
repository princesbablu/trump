...
export default function Header() {
  ...
  return (
    <>
      <header className={`heading bg-white border-bottom border-2 border-black ${scrolled ? 'position-fixed' : ''}`}>
        <Container>
          <div className='heading-wrap d-flex align-items-center justify-content-between'>
            ...
            <div className="heading-actions d-flex align-items-center flex-wrap">
              ...
              <a href='#' target='_blank' className='btn text-white text-uppercase bg-secondary border border-2 border-black'>Buy Trump coin</a>
